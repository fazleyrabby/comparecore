...
<div class="mb-6">
    ...
    <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Add Category</h2>
</div>
...
<form action="{{ route('admin.categories.store') }}" method="POST" class="max-w-2xl">
    ...
    <div class="mt-6 flex items-center gap-3">
        <button type="submit" class="px-5 py-2.5 bg-indigo-600 text-white text-sm font-medium rounded-lg hover:bg-indigo-700 transition-colors">Create Category</button>
