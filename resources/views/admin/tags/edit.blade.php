...
<div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-900 dark:border-gray-800">
    <div class="p-6 border-b border-gray-200 dark:border-gray-800">
        <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Edit Tag</h2>
    </div>
    ...
    <form action="{{ route('admin.tags.update', $tag) }}" method="POST">
        ...
        <div class="p-6 border-t border-gray-200 dark:border-gray-800 flex justify-end gap-3">
            ...
            <button type="submit" class="px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-lg hover:bg-indigo-700 transition-colors">Update Tag</button>
        </div>
    </form>
</div>
@endsection
